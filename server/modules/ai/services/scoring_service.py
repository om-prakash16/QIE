...
class ProofScoreService:
    def __init__(self):
        ...
        self.weights = {"skill_score": 0.4, "github_score": 0.3, "project_score": 0.3}
    ...
    async def calculate_proof_score(self, scores: Dict[str, float]) -> Dict[str, Any]:
        ...
        return {
            ...
            "breakdown": {
                "skill_contribution": scores.get("skill_score", 0)
                * self.weights["skill_score"],
                "github_contribution": scores.get("github_score", 0)
                * self.weights["github_score"],
                "project_contribution": scores.get("project_score", 0)
                * self.weights["project_score"],
            },
            "level": level,
