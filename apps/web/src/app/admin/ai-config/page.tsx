...
import { AIConfigPanel } from "@/features/admin/AIConfigPanel"
            ...
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 relative z-20">
                ...
                >
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary/70 mb-1">Intelligence Layer</p>
