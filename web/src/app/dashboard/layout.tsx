...
const candidateLinks = [
    ...
    { href: "/dashboard/skills", label: "Skill Verify", icon: Shield },
    { href: "/dashboard/portfolio", label: "Portfolio", icon: FolderGit2 },
    { href: "/dashboard/reputation", label: "Reputation", icon: Trophy },
    { href: "/dashboard/nfts", label: "NFT Credentials", icon: Gem },
    { href: "/dashboard/insights", label: "AI Insights", icon: Brain },
    { href: "/dashboard/career", label: "Career Roadmap", icon: Route },
    { href: "/dashboard/interview", label: "Interview Prep", icon: Gamepad2 },
