            ...
            <div className="container mx-auto px-4 max-w-3xl space-y-16 py-12">
                ...
                <section className="space-y-4">
                    ...
                    <div className="prose prose-neutral dark:prose-invert max-w-none text-muted-foreground leading-7">
                        <p>
                            Best Hiring Tool is a specialized platform designed to bridge the gap between engineering talent and forward-thinking companies. By integrating direct data sources like GitHub, we move beyond static resumes to offer a dynamic, proof-based representation of technical skill.
                        </p>
                        <p>
                    ...
                    <div className="bg-primary/5 border border-primary/10 rounded-lg p-6">
                        <div className="flex gap-4 items-start">
                            ...
                            <p className="text-sm text-muted-foreground leading-relaxed">
                                <span className="font-semibold text-foreground">Commitment to Quality:</span> Best Hiring Tool is built with a professional intent: to make the hiring ecosystem more efficient, fair, and data-driven. We are committed to continuous improvement, refining our tools to serve the evolving needs of the technical industry.
                            </p>
                        </div>
                    </div>
                </section>
